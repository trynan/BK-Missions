...
codes_check.grid(row = 2, column = 0, pady=10)

# main button
main_button = tk.Button(window)
main_button.grid(row = 3, column = 0, pady=10)

# show missions button
missions_button = tk.Button(window)
missions_button.grid(row = 4, column = 0, pady=10)
...
vscrollb.grid(row = 0, column = 2, sticky='nsew', rowspan = 6)

# text
text = tk.Text(window)
text['yscrollcommand'] = vscrollb.set
text.grid(row = 0, column = 1, sticky='nsew', rowspan = 6)
...
# ----------------- LONG MISSION LIST -----------------
        missions = [
            [ # MAIN_OBJECTIVE
                ...
                Mission(["J", "R"],         "1. Main Objective", "{} jiggies [r 80-90]".format(random.randint(80,90))),
            ...
            [ # SIDE_QUEST
                Mission(["H", "A"],         "2. Side Quest", "{} HCs [r 14-18]".format(random.randint(14,18))),
                ...
                Mission(["T"],              "2. Side Quest", "{} tokens [r 70-90]".format(random.randint(70,90))),
                Mission(["J"],              "2. Side Quest", "{} jiggies [r 40-55]".format(random.randint(40,55))),
            ...
            [ # EARLY_GAME
                ...
                Mission(["J", "A"],         "3. Early Game", "{} jiggies in TTC [r 8-10]".format(random.randint(8,10))),
                Mission(["J", "A"],         "3. Early Game", "{} jiggies in CC [r 8-10]".format(random.randint(8,10))),
                Mission(["N", "A"],         "3. Early Game", "{} notes in CC [r 75-100]".format(random.randint(75,100))),
                Mission(["N", "A"],         "3. Early Game", "{} notes in FP [r 75-100]".format(random.randint(75,100))),
                ...
                Mission(["J", "A"],         "3. Early Game", "{} jiggies in FP [r 4-9]".format(random.randint(4,9))),
            ...
            [ # MID_GAME
                ...
                Mission(["J", "A"],         "4. Mid Game", "{} jiggies in MMM [r 5-10]".format(random.randint(5,10))),
                Mission(["J", "A"],         "4. Mid Game", "{} jiggies in RBB [r 3-10]".format(random.randint(3,10))),
                Mission(["N", "A"],         "4. Mid Game", "{} notes in MMM [r 50-100]".format(random.randint(50,100))),
                Mission(["N", "A"],         "4. Mid Game", "{} notes in GV [r 40-100]".format(random.randint(40,100))),
                Mission(["N", "A"],         "4. Mid Game", "{} notes in RBB [r 40-100]".format(random.randint(40,100))),
                Mission(["H", "A"],         "4. Mid Game", "Both HCs in MMM"),
                Mission(["H", "A"],         "4. Mid Game", "Both HCs in GV"),
                Mission(["H", "A"],         "4. Mid Game", "Both HCs in RBB"),
                Mission(["T", "A"],         "4. Mid Game", "{} tokens in MMM [r 10-16]".format(random.randint(10,16))),
                Mission(["T", "A"],         "4. Mid Game", "All tokens in GV"),
                Mission(["T", "A"],         "4. Mid Game", "{} tokens in RBB [r 10-15]".format(random.randint(10,15))),
                ...
                Mission(["J", "A"],         "4. Mid Game", "{} jiggies in GV [r 3-9]".format(random.randint(3,9))),
                # Mission([],      "4. Mid Game", ""),
            ],
            [ # LATE_GAME
                Mission(["O", "A"],         "5. Late Game", "All Jinjos in CCW"),
                Mission(["O", "A"],         "5. Late Game", "All Jinjos in BGS"),
                Mission(["N", "A"],         "5. Late Game", "{} notes in BGS [r 50-100]".format(random.randint(50,100))),
                ...
                Mission(["N", "A"],         "5. Late Game", "{} notes in CCW [r 30-80]".format(random.randint(30,80))),
                Mission(["J", "A"],         "5. Late Game", "{} jiggies in CCW [r 3-8]".format(random.randint(3,8))),
                Mission(["J"],              "5. Late Game", "{} jiggies in BGS [r 5-8]".format(random.randint(5,8))),
                Mission(["T", "A"],         "5. Late Game", "{} tokens in CCW [r 15-25]".format(random.randint(15,25))),
...
# ----------------- SHORT MISSION LIST -----------------
        missions = [
            [ # MAIN_OBJECTIVE
                ...
                Mission(["T"],              "1. Main Objective", "{} tokens [r 70-90]".format(random.randint(70,90))),
                Mission(["J"],              "1. Main Objective", "{} jiggies [r 40-55]".format(random.randint(40,55))),
            ...
            [ # EARLY_GAME
                ...
                Mission(["J", "A"],         "2. Early Game", "{} jiggies in TTC [r 8-10]".format(random.randint(8,10))),
                Mission(["J", "A"],         "2. Early Game", "{} jiggies in CC [r 8-10]".format(random.randint(8,10))),
                Mission(["N", "A"],         "2. Early Game", "{} notes in CC [r 75-100]".format(random.randint(75,100))),
                Mission(["N", "A"],         "2. Early Game", "{} notes in FP [r 75-100]".format(random.randint(75,100))),
                ...
                Mission(["J", "A"],         "2. Early Game", "{} jiggies in FP [r 4-9]".format(random.randint(4,9))),
                ...
                Mission(["J", "A"],         "2. Early Game", "{} jiggies in MMM [r 5-10]".format(random.randint(5,10))),
                Mission(["N", "A"],         "2. Early Game", "{} notes in MMM [r 50-100]".format(random.randint(50,100))),
                Mission(["H", "A"],         "2. Early Game", "Both HCs in MMM"),
                Mission(["T", "A"],         "2. Early Game", "{} tokens in MMM [r 10-16]".format(random.randint(10,16))),
            ...
            [ # LATE_GAME
                ...
                Mission(["N", "A"],         "3. Late Game", "{} notes in GV [r 40-100]".format(random.randint(40,100))),
                ...
                Mission(["J", "A"],         "3. Late Game", "{} jiggies in GV [r 3-9]".format(random.randint(3,9))),
                Mission(["J"],              "3. Late Game", "Abuse Gobi (beak bust Gobi at all 5 locations)"),
                Mission(["O", "A"],         "3. Late Game", "All Jinjos in RBB"),
                Mission(["J", "A"],         "3. Late Game", "{} jiggies in RBB [r 3-10]".format(random.randint(3,10))),
                Mission(["N", "A"],         "3. Late Game", "{} notes in RBB [r 40-100]".format(random.randint(40,100))),
                Mission(["H", "A"],         "3. Late Game", "Both HCs in RBB"),
                Mission(["T", "A"],         "3. Late Game", "{} tokens in RBB [r 10-15]".format(random.randint(10,15))),
                Mission(["O", "A"],         "3. Late Game", "All Jinjos in CCW"),
                Mission(["O", "A"],         "3. Late Game", "All Jinjos in BGS"),
                Mission(["N", "A"],         "3. Late Game", "{} notes in BGS [r 50-100]".format(random.randint(50,100))),
                ...
                Mission(["N", "A"],         "3. Late Game", "{} notes in CCW [r 30-80]".format(random.randint(30,80))),
                Mission(["J", "A"],         "3. Late Game", "{} jiggies in CCW [r 3-8]".format(random.randint(3,8))),
                Mission(["J"],              "3. Late Game", "{} jiggies in BGS [r 5-9]".format(random.randint(5,9))),
                Mission(["T", "A"],         "3. Late Game", "{} tokens in CCW [r 15-25]".format(random.randint(15,25))),
